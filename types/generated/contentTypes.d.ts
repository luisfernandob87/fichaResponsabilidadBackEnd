...
export interface ApiEquipoEquipo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    estado: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiFichaFicha extends Schema.CollectionType {
  ...
  attributes: {
    fechaEntrega: Attribute.Date;
    equipo: Attribute.Relation<
      'api::ficha.ficha',
      'oneToOne',
      'api::equipo.equipo'
    >;
    serie: Attribute.String;
    ...
    fechaDevolucion: Attribute.Date;
    firmaResponsable: Attribute.Text;
    firmaEncargado: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTecnicoTecnico extends Schema.CollectionType {
...
export interface ApiUbicacionUbicacion extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::tecnico.tecnico': ApiTecnicoTecnico;
